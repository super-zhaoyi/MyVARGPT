...
from visionllm.vargpt_qwen_v1_1.var_model.infinity.models.infinity import Infinity
from visionllm.vargpt_qwen_v1_1.var_model.infinity.models.basic import *
...
def load_infinity(
    ...
    with torch.cuda.amp.autocast(enabled=True, dtype=torch.bfloat16, cache_enabled=True), torch.no_grad():
        infinity_test: Infinity = Infinity(
            ...
            checkpointing=False, # full-block
...
def load_infinity_train(
    ...
    print(f'[you selected Infinity with {model_kwargs=}] model size: {sum(p.numel() for p in var_model.parameters())/1e9:.2f}B, bf16={bf16}')
...
def load_visual_tokenizer(args):
    ...
    if args.vae_type in [16,18,20,24,32,64]:
        from visionllm.vargpt_qwen_v1_1.var_model.infinity.models.bsq_vae.vae import vae_model
