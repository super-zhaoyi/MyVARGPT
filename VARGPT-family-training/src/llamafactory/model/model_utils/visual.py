...
def get_forbidden_modules(config: "PretrainedConfig", finetuning_args: "FinetuningArguments") -> Set[str]:
    ...
    if model_type in ["llava", "llava_next", "llava_next_video", "paligemma", "video_llava", "qllava"]:
    ...
    elif model_type == "vargpt_qwen2_vl":
        stage = finetuning_args.vargpt_train_stage
        vargpt_version = finetuning_args.vargpt_version
        print(f"vargpt_version: {vargpt_version}")
        print(f"stage: {stage}")
        if vargpt_version == "qwen2vl-v1.0":
            if stage == 1:
                forbidden_modules.add("model")
                forbidden_modules.add("language_model")
                forbidden_modules.add("lm_head")
                forbidden_modules.add("visual")
                forbidden_modules.add("vae")
                forbidden_modules.add("vargpt_gen.blocks")
                forbidden_modules.add("vargpt_gen.pos_1LC")
                forbidden_modules.add("vargpt_gen.pos_start")
                forbidden_modules.add("vargpt_gen.word_embed")
                forbidden_modules.add("vargpt_gen.lvl_embed")
                forbidden_modules.add("vargpt_gen.head")
            elif stage ==2:
                forbidden_modules.add("image_gen_projector")
                forbidden_modules.add("visual")
                forbidden_modules.add("vae")
                forbidden_modules.add("vargpt_gen.blocks")
                forbidden_modules.add("vargpt_gen.pos_1LC")
                ...
                forbidden_modules.add("vargpt_gen.lvl_embed")
                forbidden_modules.add("vargpt_gen.head")
                forbidden_modules.add("vargpt_gen.class")
            elif stage == 3:
                forbidden_modules.add("model")
                forbidden_modules.add("language_model")
                forbidden_modules.add("lm_head")
        ...
        elif vargpt_version == "qwen2vl-v1.1":
            if stage == 0: 
                forbidden_modules.add("model")
                forbidden_modules.add("language_model")
                forbidden_modules.add("lm_head")
                forbidden_modules.add("visual")
                forbidden_modules.add("vae_local")
                ...
                forbidden_modules.add("visual")
                forbidden_modules.add("vae_local")
                forbidden_modules.add("vargpt_gen")
                ...
                forbidden_modules.add("vae_local")
                forbidden_modules.add("vargpt_gen")
                forbidden_modules.add("sos_embedding") 
                forbidden_modules.add("image_gen_projector")
                forbidden_modules.add("image_gen_projector_out")
            ...
            assert False, "Invalid vargpt_version"
    elif model_type == "vargpt_llava":
        stage = finetuning_args.vargpt_train_stage
        vargpt_version = finetuning_args.vargpt_version
        print(f"vargpt_version: {vargpt_version}")
        print(f"stage: {stage}")
        if vargpt_version == "llava-v1.0":
            if stage == 1:
                forbidden_modules.add("language_model")
                forbidden_modules.add("lm_head")
                forbidden_modules.add("vision_tower")
