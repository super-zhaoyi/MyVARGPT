...
class InfinityTrainer(object):
    ...
    def train_step(
        ...
        # text_cond_tuple (torch.Size([80, 2048]), [15, 65], tensor([ 0, 15, 80], device='cuda:0', dtype=torch.int32), 65)
        # text_cond_tuple (torch.Size([345, 2048]), [333, 12], tensor([  0, 333, 345], device='cuda:0', dtype=torch.int32), 333 )
